...
if (enterNumber === false) {
    ...
    var magicNumber = prompt("Kindly enter a number.");
    if ((magicNumber % 2) === 0) {
        alert("This is an even number.")
    } else if ((magicNumber % 2) === 1) {
        alert("This number can't even.")
    }

    alert(magicNumber + " plus 100 is " + (+magicNumber + 100));
    if (magicNumber > 0) {
        alert("I'm positive that this number is positive.");
    } else if (magicNumber < 0) {
        alert("Negative number is negative.")
    }
}}
